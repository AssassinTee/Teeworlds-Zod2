...
MACRO_CONFIG_INT(SvPlayerSlots, sv_player_slots, 4, 0, MAX_CHARACTERS, CFGFLAG_SAVE|CFGFLAG_SERVER, "Number of slots to reserve for playes, rest is for zombies")
